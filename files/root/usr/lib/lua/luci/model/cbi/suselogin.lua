...
isp:value("%E8%87%AA%E8%B4%A1%E7%A7%BB%E5%8A%A8", translate("自贡移动互联网"))
isp:value("%E8%87%AA%E8%B4%A1%E8%81%94%E9%80%9A", translate("自贡联通互联网"))
...
success.description = translate("<input type=\"button\" class=\"cbi-button cbi-button-save\" value=\"打开认证页\" onclick=\"window.open('http://10.60.208.4')\" /><input type=\"button\" class=\"cbi-button cbi-button-save\" value=\"打开自助服务\" onclick=\"window.open('http://10.60.224.200:8080/selfservice')\" /><br />可查看认证状态和管理在线设备")
